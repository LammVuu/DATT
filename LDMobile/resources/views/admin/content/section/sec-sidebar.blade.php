...
<div class="sidebar custom-scrollbar">
    <div class="sidebar-avt">
        <div class="d-flex flex-column">
            <img src="{{$url_user.$user->anhdaidien}}" id="avatarSideBarUser" alt="" class="circle-img center-img">
            <div class="white mt-10" id="nameSideBar">{{$user->hoten}}</div>
        </div>
    </div>
    <!-- link -->
    <div class="sidebar-menu">
        <a href={{route('admin/dashboard')}} class="sidebar-link @yield('sidebar-dashboard')">
            <div data-link="dashboard" class="sidebar-icon"><i class="fas fa-home"></i></div>
